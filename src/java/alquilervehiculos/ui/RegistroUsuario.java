...
public class RegistroUsuario extends JFrame {
    ...
    private void init() {
        ...
        btnRegistro.addActionListener(e -> registro(txtNombre.getText(), txtApellido.getText(), txtEmail.getText(),
    ...
    private void registro(String nombre, String apellido, String email, String dni, String telefono, String direccion,
